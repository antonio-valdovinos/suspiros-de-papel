        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-on-surface-variant text-lg font-light leading-relaxed">
            <p>
              ...
              me dio ese empujón que necesitaba: <em>"Yahaira, esto que haces
              es hermoso, ¿por qué no lo compartes con el mundo?"</em>
            </p>
            <p>
...
function ClosingSection() {
  const ref = useScrollReveal()
  const waLink = `https://wa.me/${SITE.whatsapp}?text=${encodeURIComponent("Hola Yahaira, me gustaría hacer un pedido 🌸")}`
